...
fun MockRequestHandleScope.encryptionAwareResponseDataBuilder(
    ...
    val responseEncryption = extractEncryptionSpec(request, issuerMetadataVersion)
...
private fun extractEncryptionSpec(
    request: HttpRequestData?,
    issuerMetadataVersion: IssuerMetadataVersion,
    ...
    inline fun <reified T> decrypt(request: HttpRequestData): T {
        ...
        return when (contentType) {
            "application/jwt" -> {
                ...
                val jwtClaimSet =
                    decrypt(textContent.text, spec.encryptionKeyAlgorithm, spec.encryptionMethod, loadKeySet())
                        .getOrThrow()
