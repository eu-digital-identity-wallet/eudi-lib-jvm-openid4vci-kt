...
interface Issuer :
    ...
    companion object {
        ...
        val DefaultResponseEncryptionSpecFactory: ResponseEncryptionSpecFactory =
            { supportedResponseEncryptionParameters, encryptionSupportConfig ->
                ...
                val compressionAlg = when (supportedPayloadCompression) {
                    ...
                    is PayloadCompression.Supported ->
                        encryptionSupportConfig.compressionAlgorithms?.intersect(supportedPayloadCompression.algorithms)?.firstOrNull()
                }
                ...
                supportedResponseEncryptionParameters.algorithms.firstNotNullOfOrNull { alg ->
                    KeyGenerator.genKeyIfSupported(encryptionSupportConfig, alg)?.let { jwk ->
